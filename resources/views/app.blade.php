...
<body>
            ...
            <div id="app-form">
                ...
                <form id="appointment-form" method="POST">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            <label for="inputMiddleName"></label>
                            <input type="text" class="form-control" id="inputMiddleName" placeholder="Middle Name">
                        </div>
                        <div class="col-lg-2">
                            <label for="inputSuffix"></label>
                            <input type="text" class="form-control" id="inputSuffix" placeholder="Suffix">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-4">
    ...
    <script src="{{ asset('js/div-height.js') }}"></script>
    <script src="{{ asset('js/form.js') }}"></script>
    <script src="{{ asset('js/clear-inputs.js') }}"></script>
