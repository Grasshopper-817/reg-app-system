...
<head>
    ...
    <title>FAQs | MSU-MSAT Registrar's Online Appointment</title>
    <!-- bootstrap -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-aFq/bzH65dt+w6FI2ooMVUpc+21e0SRygnTpmBvdBgSdnuTN7QbdgL+OapgHtvPp" crossorigin="anonymous">
    
    <link rel="stylesheet" href="css/faqs-announcement/faqs.css">
    ...
    <div class="faqs-cover">
        <div class="content">
            ...
            <div class="head container d-flex flex-column align-items-center justify-content-center font-white">
                <p class="display-2 font-corm font-bold">FAQ</p>
                <p class="h4 font-corm">Frequently Asked Questions</p>
            </div>
        </div>
    </div>

    <div class="faqs-content">
        <div class="content-bar d-flex flex-row">
            <ul class="nav justify-content-start">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#" onclick="featuredView()">Featured Articles</a>
                </li>
                <li class="nav-item"><span class="nav-link divider">|</span></li>
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="other_quesView()">Other Questions</a>
                </li>
            </ul>
        </div>
        <div class="content-display">
            <div id="content-featured-articles">
                <div class="accordion accordion-flush" id="featured-articles">
            ...
            <div id="content-other-questions">
                <div class="accordion accordion-flush" id="other-questions">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
